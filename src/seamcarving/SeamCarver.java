...
import seamcarving.seamfinding.DynamicProgrammingSeamFinder;
import seamcarving.seamfinding.GenerativeSeamFinder;
...
public class SeamCarver {
    ...
    private static final String INPUT_PATH = "data/seamcarving/panda.png";
    /**
    ...
    public static void main(String[] args) throws IOException {
        ...
        // .picture().save(new File(OUTPUT_PATH));
    ...
    //***
    /**
     * Reduces image dimensions based on user input.
     *
     * @param seamCarver   a seam carver reading from the given input file.
     * @throws IOException if an error occurs during reading.
     */
